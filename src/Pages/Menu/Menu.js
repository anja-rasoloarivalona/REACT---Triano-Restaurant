...
class Menu extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <Header background={background} text1="Our" text2="MENU" />
        ...
        <section className={classes.Menu}>
          <nav className={classes.Navbar}>
            <ul className={classes.List}>
              <li
                style={{
                  backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)), url(" +lunch +")",
          ...
          <Route exact path="/menu/" component={Lunch} />
          <Route path="/menu/diner" component={Diner} />
          <Route path="/menu/brunch" component={Brunch} />
        </section>
      </React.Fragment>
    );
  }
